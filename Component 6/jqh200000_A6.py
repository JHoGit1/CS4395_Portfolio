...
def web_crawler(link):
    ...
    with open('urls.txt', 'w') as f:
        for link in soup.find_all('a'):
            ...
            if 'Mario' in link_str or 'mario' in link_str:
...
if __name__ == '__main__':
    link_to_crawl = "https://www.google.com/search?q=mario&oq=mario&aqs=edge.0.69i59j0i67l3j0i512l2j0i67j0i512j69i61.506j0j9&sourceid=chrome&ie=UTF-8"
